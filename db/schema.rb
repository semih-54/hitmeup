...
ActiveRecord::Schema[7.1].define(version: 2023_11_23_084946) do
  ...
  create_table "hitman_scenarios", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hitman_id"], name: "index_hitman_scenarios_on_hitman_id"
    t.index ["scenario_id"], name: "index_hitman_scenarios_on_scenario_id"
  end

  create_table "hitman_skills", force: :cascade do |t|
    t.bigint "skill_id", null: false
    t.bigint "hitman_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hitman_id"], name: "index_hitman_skills_on_hitman_id"
    t.index ["skill_id"], name: "index_hitman_skills_on_skill_id"
  end
